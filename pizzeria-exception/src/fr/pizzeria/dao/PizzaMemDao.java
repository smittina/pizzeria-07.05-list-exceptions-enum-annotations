...
public class PizzaMemDao implements IPizzaDao {
	...
	public PizzaMemDao() {
		...
		Pizza p = new Pizza(0,"PEP", "Pépéroni",12.50);
		lesPizzas.add(p);
		p =  new Pizza(1,"MAR", "Margherita",14.00);
		lesPizzas.add(p);
		p =  new Pizza(2,"REIN", "La Reine",11.50);
		lesPizzas.add(p);
		p =  new Pizza(3,"FRO", "La 4 Fromages",12.00);
		lesPizzas.add(p);
		p =   new Pizza(4,"CAN", "La cannibale",12.50);
		lesPizzas.add(p);
		p =  new Pizza(5,"SAV", "La Savoyarde",13.00);
		lesPizzas.add(p);
		p =  new Pizza(6,"ORI", "L'Orientale",13.50);
		lesPizzas.add(p);
		p =  new Pizza(7,"IND", "L'indienne",14.00);
		lesPizzas.add(p); 
	}
